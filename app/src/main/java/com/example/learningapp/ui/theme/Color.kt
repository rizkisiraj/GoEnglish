...
val BlueVolume = Color(0xFF687EFF)
val BlueButtonShadow = Color(0xFF343F80)

val RedBackground = Color(0xFFFEBFBF)
val Red = Color(0xFFC9553C)
val RedShadow = Color(0xFFA62F2F)

val GreenBackground = Color(0xFFDFFEBF)
val Green = Color(0xFF7CB342)
val GreenShadow = Color(0xFF52772C)
val Blue = Color(0xFFE0F4FF)
val BlueShadow = Color(0xFF87C4FF)
